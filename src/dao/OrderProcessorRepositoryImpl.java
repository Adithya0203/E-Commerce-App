...
public abstract class OrderProcessorRepositoryImpl implements OrderProcessorRepository {
   ...
   @Override
   public List getOrdersByCustomer(int customerId) throws OrderNotFoundException, CustomerNotFoundException {
