...
public interface OrderProcessorRepository {
   ...
   boolean deleteProduct(int productId) throws ProductNotFoundException, ProductNotFoundException;
...
boolean deleteOrder(int orderIdToDelete) throws OrderNotFoundException, OrderNotFoundException;
